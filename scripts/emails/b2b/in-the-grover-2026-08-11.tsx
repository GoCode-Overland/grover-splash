    ...
    <Container className="email-card" style={containerStyle}>
      ...
      <Section style={sectionStyle}>
        <Text className="intro-text" style={introStyle}>
          Three things this week. The big one is that your customers can finally see the documents you set up for them.
        </Text>
      </Section>
...
export default function InTheGrover20260811() {
  return (
    <Html lang="en">
      <Head>
