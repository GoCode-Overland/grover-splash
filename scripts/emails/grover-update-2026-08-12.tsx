    ...
    <Container className="email-card" style={containerStyle}>
          ...
          <Section style={sectionStyle}>
            <Text className="intro-text" style={introStyle}>
              New name on the app, and one place to see everything Grover already knows about your rig.
            </Text>
          </Section>
          ...
          <Section style={cardOuterStyle}>
            <div className="box-card" style={cardStyle}>
              ...
              {/* App name change */}
              <Text className="item-title" style={itemTitleStyle}>Grover: Camping and Community</Text>
              <Text className="item-body" style={itemBodyStyle}>
                Same app, new name. There's a new rig logo on it too, and the van silhouette is finally gone from the Rig button. This was the plan from the beginning. Grover was never a van-only thing, and now the app says so where everyone can see it.
              </Text>
              <Text className="item-body" style={itemBodyStyle}>
                Because look who's actually out here. Class C and Class B coaches. Truck campers riding on Tacomas and F-250s. Pickups, SUVs, a towable, and one genuinely excellent shuttle bus. Sprinters and Transits still turn up in force and always will. They were just never the whole crowd.
              </Text>
              <Text className="item-body" style={itemBodyStyle}>
                So if your rig isn't a van, you're not the exception. You're the point. Fill in your spec sheet and Grover answers with your clearance and your tank sizes instead of some generic build's.
              </Text>
          ...
          <Section style={ctaSectionStyle}>
            ...
            <Text className="item-body" style={{ ...itemBodyStyle, marginBottom: '10px' }}>
              Five minutes on the couch tonight beats guessing at a trailhead on Saturday. Open the app, tap Rig, tap Specs, and put in what you actually built or bought. Whatever it is you're sleeping in, the more of it Grover has, the more its answers are about your rig instead of rigs in general.
            </Text>
            ...
            <Row>
              <Column style={{ paddingRight: '8px' }}>
                <Link href="https://apps.apple.com/app/id6742468326" style={ctaButtonStyle}>
...
export default function GroverUpdate20260812() {
  return (
    <Html lang="en">
      <Head>
        <style>{darkMode}</style>
      </Head>
      <Preview>Camping and Community. Plus one home for every spec and document on your rig.</Preview>
