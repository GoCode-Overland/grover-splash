...
import GroverUpdate20260727 from './emails/grover-update-2026-07-27.js';
...
const html = await render(GroverUpdate20260727());
const text = await render(GroverUpdate20260727(), { plainText: true });

const payload = {
  audienceId: RESEND_AUDIENCE_ID,
  from: `Will @ Grover <${RESEND_FROM}>`,
  replyTo: 'will@getgrover.ai',
  subject: 'New fire and smoke layers on the map',
  html,
  text,
  name: 'Joyride Journal - Jul 27, 2026',
};
